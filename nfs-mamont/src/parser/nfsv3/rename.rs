...
mod tests {
    ...
    fn test_rename() {
        ...
        const DATA: &[u8] = &[
            ...
            0x00, 0x00, 0x00, 0x04, b'o', b'l', b'd', b'n',
            0x00, 0x00, 0x00, 0x09, 0x00, 0x09, 0x0A, 0x0B,
        ...
        assert_eq!(result.from.dir.0, [0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08]);
        assert_eq!(result.from.name.as_str(), "oldn");
        assert_eq!(result.to.dir.0, [0x00, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10]);
